...
const Index = () => {
  const [form, setForm] = useState({
    ...
    lineSpeed: "",
    printSize: "",
    uniqueNumber: Math.floor(Math.random() * 1000000) // Unique number for tracking
  });
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    const addressLabel = `Cyklop CSC Att.: SampleLab M.Slot ${form.uniqueNumber}\nWilhelm Röntgenstraat 10\n8013NC\nZwolle\nNederland`;
    toast({
      title: "Form submitted.",
      description: `We've received your sample request. Your tracking number is ${form.uniqueNumber}. Please use the following address for your sample:\n${addressLabel}`,
      status: "success",
      duration: 5000,
      isClosable: true,
    });
